		...
		<div id="list-item" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="imageType" title="${message(code: 'item.imageType.label', default: 'Image Type')}" />
					
						<g:sortableColumn property="age" title="${message(code: 'item.age.label', default: 'Age')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: itemInstance, field: "imageType")}</td>
					
						<td>${fieldValue(bean: itemInstance, field: "age")}</td>
